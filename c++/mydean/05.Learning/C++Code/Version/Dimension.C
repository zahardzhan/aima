...
// Given the name of a value, lookup the associated index
int Dimension::lookup(char temp[])
{
   for(int x = 0; x < num_values; x++)
      if(strcmp(temp, values[x]) == 0)   // Compare the strings. 0 means match
         return x;
}

// Return the name of the attribute of this dimension

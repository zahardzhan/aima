...
{
	/// <summary>
	/// Summary description for DecapawnBoard.
	/// </summary>
	public class DecapawnBoard
	{
		...
		string[] bottomRow = { "W", "W", "W", "W", "W"};

//		string[] topRow = { " ", " ", " ", "B", "B" };
//
//		string[] midTopRow = { "B", " ", "W", " ", " " };
//
//		string[] middleRow = { "W", " ", " ", " ", " " };
//
//		string[] midBottomRow = { " ", "B", "W", " ", " " };
//
//		string[] bottomRow = { " ", " ", " ", "W", "W"};

		public DecapawnBoard()
		{
			//
		...
		public DecapawnBoard cloneBoard() 
		{
			return (DecapawnBoard) clone();
		}
